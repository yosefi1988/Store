...
namespace WebApplicationStore.Controllers.Classroom
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Family,Company,Email,Description")] Employee0 employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Family,Company,Email,Description")] Employee0 employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
